#!/bin/bash --login
#SBATCH -o output/cleanuppt4.out
#SBATCH -J tracker
#SBATCH --export=ALL
...
export curymdh=2019080100  # date from netcdf file
export cmodel=cnnr

export HOMEtrak=/scratch2/GFDL/gfdlscr/Caitlyn.Mcallister/runtracker
export rundir=${HOMEtrak}/run/
export workroot=/scratch2/GFDL/gfdlscr/Caitlyn.Mcallister/runtracker/work
...
connor_tshddir=/scratch2/NAGAPE/aoml-osse/ECMWF.1km/scripts.fd/tracker_data/v2
...
connor_file=hipqtc1_redux2_flip_float.nc

if [ -s ${wdir}/connor_combined.${PDY}${cyc}.nc ]; then
  ...
  netcdf_combined_file=${wdir}/connor_combined.${PDY}${cyc}.nc
  ...
  ncks --fl_fmt=64bit -F -v z500,z400,z300,u1000,v1000,t300,t400,u500,v500,t500,u700,v700,u850,v850,u925,v925,u10m,v10m,MSLP ${connor_tshddir}/${connor_file} ${netcdf_combined_file} || exit 1

fi

netcdffile=${wdir}/connor_combined.${PDY}${cyc}.nc
...
/scratch2/GFDL/gfdlscr/Caitlyn.Mcallister/runtracker/code/exec/gettrk.x <${namelist}
gettrk_rcc=$?
