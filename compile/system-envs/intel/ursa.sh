...
# for compiling and running the Vortex Tracker on URSA with Intel.
...
export ncdump=/apps/spack-2024-12/linux-rocky9-x86_64/oneapi-2025.3.1/netcdf-c-4.9.2-bnv72ii4gwaskzhvs5njhwbbgyl4f6v2/bin/ncdump
